...
<template>
    <div class="bg-white hover:backdrop-blur-sm max-w-sm rounded overflow-hidden shadow-lg px-6 py-4" draggable="true" @dragstart="drag" :data-value="JSON.stringify(task)" @dragover.prevent @drop.prevent="drop">
